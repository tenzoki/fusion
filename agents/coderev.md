...
3. Save result directly to `fusion-workbench/codereview/YYYY-MM-DD-NN-<short-description>.md` (e.g. `260406-01-prompt-template-variable-mismatch.md`)
...
5. Write to `fusion-workbench/codereview/YYYY-MM-DD_HH-MM-<topic>.md`
6. Include:
