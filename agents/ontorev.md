...
2. Save result directly to `fusion-workbench/ontoreview/MMDD-NN-<short-description>.md` (e.g. `0326-01-horizon-review.md`)
...
2. Consolidate into a structured review document at `fusion-workbench/ontoreview/MMDD-<topic>.md`
3. Include:
