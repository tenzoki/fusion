...
1. Create if missing: `fusion-workbench/{planning,decisions,history,issues}`
...
5. **Document** in `fusion-workbench/planning/MMDD-HHMM[o]-<topic>.md` — this is mandatory, never skip it
