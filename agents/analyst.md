...
1. Create if missing: `fusion-workbench/{analyses,decisions,history,issues}`
...
- `fusion-workbench/analyses/MMDD-HHMM-<topic>.md` — analysis reports
- `fusion-workbench/history/MMDD-HHMM-<topic>.md` — session log
...
4. Write to `fusion-workbench/decisions/MMDD-HHMM[o]-<topic>.md` per the decision-record template in `fusion-workbench-conventions.md`
...
5. Write to `fusion-workbench/analyses/MMDD-HHMM-snapshot-<topic>.md` using the architectural-snapshot template below
...
Each analysis produces one report file at `fusion-workbench/analyses/MMDD-HHMM-<topic>.md`. Obtain `MMDD-HHMM` from `date +%m%d-%H%M`.
...
- `fusion-workbench/issues/MMDD-HHMM[o]-<topic>.md` — <one-line summary>
- ...
