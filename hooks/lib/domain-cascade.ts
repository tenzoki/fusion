  ...
  excluded: [
    {
      ...
      measured: "clean",
      note:
        "Left out on a measured cost that has since expired. A line in `docs/philosophy.md` said what " +
    ...
    },
    {
      ...
      measured: "clean",
      note:
        "Documentation about the check, including this block. Not scanned, and it would be " +
