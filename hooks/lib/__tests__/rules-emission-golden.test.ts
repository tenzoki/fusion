...
//
// THE UNIVERSAL-CORE GROWTH BOUND WAS RETIRED ON 2026-09-11: the DISPATCH-PATH BOUND at
// the foot of this file charges every core byte eleven times at zero head-room, so it
// dominates. `RULE_BASELINE`'s first five entries are the 2026-08-14 arming sizes, the
// rest the 2026-08-05 post-cut sizes. The argument, the cut log and the standing cleanup table are in
// `260922-0939-rules-emission-golden-cut-log-and-retired-core-bound-argument-2026-08-05-to-2026-09-11.md`.
//
...
// measures a role's extras from, and the CUT LOG rolled into the record named at
// the top of this header is where this surface's own events are recorded, including
// the 2026-08-14 arming entry that is the only non-cut in it and whose gate is now
// retired. Event 3 (a merge) has not reached
