 ...
 * link is expanded by hand (`readlink`, resolved against the link's own
 * directory) and re-resolved. Link expansion is bounded: a symlink cycle
 * exhausts the budget and returns null, which refuses the grant.
 *
