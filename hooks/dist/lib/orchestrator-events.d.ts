 ...
 */
export declare function readCheckoutId(root: string): string | undefined;
/**
 ...
 */
export declare function newestHookSessionStart(root: string): SessionStartEventRow | null;
