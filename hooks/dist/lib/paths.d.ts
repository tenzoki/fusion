 ...
 */
export declare function foldCase(path: string): string;
/**
 ...
 * reads as this one.
 */
export declare function matchesAnyFolded(filePath: string, patterns: readonly string[]): boolean;
/**
 ...
 */
export declare function collapseSegments(path: string): string;
/**
 ...
 */
export declare function canonicalise(path: string): string;
