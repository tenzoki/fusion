 ...
 * ancestor at all.
 */
function resolveLocation(absolutePath, hops) {
 ...
 */
export function realFsLocator(root) {
    const absolute = (path) => isAbsolute(path) ? path : joinUncollapsed(root, path);
    return {
        locate(path) {
