 ...
 * where it lands.
 */
export function rulesWriteRefusal(path, fs, spelledAs) {
    if (!path)
 ...
 */
export function isProjectRulePath(path, fs, spelledAs) {
 ...
 */
export function rulesWriteRefusalNote(path, fs, spelledAs) {
