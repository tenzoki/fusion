 ...
 */
function explainArrayOfRecordBasenames(value) {
...
const RETIRED_LEAF_KEYS = {
    ...
    "orchestrator.dispatchMinutes": "the dispatch bound was removed on 2026-09-10, and with it the stopping time a dispatch carried. Every dispatch runs to its natural end. The setting is not read, here or anywhere, and there is no replacement to move it to.",
};
