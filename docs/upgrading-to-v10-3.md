...
- `agents/planner.md` `## Where this work stops` — the section, and the paragraph beside the
  `**Decidability:**` one saying what does and does not read it. At v10.3 that heading read
