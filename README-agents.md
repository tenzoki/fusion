...
| `playmaker` | `**Domain:**` | the same two | defaults to `code`; biases the ranking heuristics | orchestrator at Phase 4 (`agents/orchestrator.md:875`), `/fusion:next` Step 3 (`skills/next/SKILL.md:97`) and again on Step 5b's second dispatch (`skills/next/SKILL.md:138`), or a direct user dispatch | `agents/playmaker.md:25-27`, `:34-36` |
