...
This rule is loaded for the planning and analysis agents (`planner`, `analyst`, `shaper`). It governs **how technical design is represented** in the documents these agents produce.
