...
| `skills/*/SKILL.md` | bytes | 21 911 | `hooks/lib/__tests__/surface-growth-bound.test.ts` |
...
**The last two figures are not the derived ones.** `skills/` was derived at 20 000 and the hook tests at 2 500, and both were raised on 2026-09-11: the hook tests once and `skills/` twice, the two `skills/` raises under different rulings and all of them read back on one date. What each raise bought, what is left of it, and what restoring the derived figure costs are in `#### The 2026-09-11 raises, and the reduction read on 2026-10-10` at the end of this section.
