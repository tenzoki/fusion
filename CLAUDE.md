...
- User-invocable skills: `/fusion:setup`, `/fusion:help`, `/fusion:upgrade`, `/fusion:memo`, `/fusion:commit`, `/fusion:log-activity`, `/fusion:revise-claude-md`, `/fusion:unlock`, `/fusion:archive`, `/fusion:migrate-workbench-v2`
