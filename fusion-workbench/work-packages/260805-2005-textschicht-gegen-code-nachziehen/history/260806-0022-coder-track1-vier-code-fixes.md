...
- Verified in a scratch workbench with the probe line extracted verbatim from the edited skill, under zsh and bash: `notes [draft].md` → OLD=0; a name in the retired bracket form, e.g. `260101-1200[o]-topic.md` → OLD=1; marker file only under `archive/` → OLD=0; migrate's narrowed survey counts 1 of the 2 bracket files.
