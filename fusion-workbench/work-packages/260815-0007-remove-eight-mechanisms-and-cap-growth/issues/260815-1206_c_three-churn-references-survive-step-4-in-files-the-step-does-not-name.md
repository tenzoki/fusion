...
Step 4 of `260815-0029_*_plan-remove-eight-mechanisms-and-cap-growth.md` removed churn
...
- `260815-0029_*_plan-remove-eight-mechanisms-and-cap-growth.md` step 4 (file list),
...
- `260815-1206-coder-step4-churn-removal.md` — the run that found them.
...
`260815-1251_*_the-three-churn-references-record-lists-three-and-two-remain.md`, which asked
for this append.
