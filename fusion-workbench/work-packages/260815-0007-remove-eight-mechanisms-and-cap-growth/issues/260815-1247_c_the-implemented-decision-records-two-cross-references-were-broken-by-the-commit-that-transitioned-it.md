...
`260811-2009_*_…md` cross-references two defect records by their `_o_` name. Commit
...
**Owner:** `ontocoder`
**Affects:** `260811-2009_*_is-the-hooks-suite-meant-to-be-run-concurrently-with-itself-and-if-not-who-serialises-it.md:7`
...
`260814-2306-orchestrator-session.md` and the Circle's history entries also name records
...
`archive/260817-1907-safe-cleanup-scoped/260814-1733_*_radical-simplification.md`'s *"Split from
`260811-0826_*_observations.md`"*. Whether that form should be the convention for every
...
---
Resolved: fixed — the two marker positions on line 7 of 260811-2009 are now _*_ and resolve to the _c_ targets; the third citation on that line was left as it stood; cd hooks && npx vitest run lib/__tests__/workbench-citation-lint.test.ts
