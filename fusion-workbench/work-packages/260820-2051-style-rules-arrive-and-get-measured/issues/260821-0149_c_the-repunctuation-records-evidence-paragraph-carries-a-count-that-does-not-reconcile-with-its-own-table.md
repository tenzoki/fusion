...
`260821-0112-ontocoder-gloss-and-repunctuation-of-the-four-profiles.md`, section "On strength, the second record's fault":
...
**Cross-references:** `260821-0147_*_the-english-em-dash-entry-lost-its-inline-demonstration-and-the-german-one-still-breaks-its-own-rule.md`.

---
Resolved: fixed — the history record carries the appended correction, three colons and three commas; 260821-0112-ontocoder-gloss-and-repunctuation-of-the-four-profiles.md:183
