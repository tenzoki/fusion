...
3. **F5 "document the exception"** landed in all three reviewers: `coderev.md:69`, `ontorev.md:62`, `conceptrev.md:32` — each "You write no separate session-history entry … a history log would only duplicate it." (Criterion 8; decision `260718-2150_*_` transitioned `_a_`→`_i_`.)
