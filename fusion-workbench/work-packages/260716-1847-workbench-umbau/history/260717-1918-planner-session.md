...
**Input:** defect issue `260717-1903_*_skill-shell-scripts-assume-bash-glob-abort-under-zsh.md`
...
- Plan: `260717-1918_*_skill-glob-nomatch-zsh-hardening.md` (6 steps, all coder, dependency-ordered; 2 Mermaid diagrams)
- This history log
