...
Filed: `260814-2128_*_the-turn-budget-records-closing-footer-says-fusion-guard-json-was-not-edited-in-the-commit-that-commits-it.md`.
...
| F3 Low — the Turn-budget record's closing footer | `260814-2128_*_the-turn-budget-records-closing-footer-says-fusion-guard-json-was-not-edited-in-the-commit-that-commits-it.md` | **resolved** by `d90b794` | The `Resolved:` footer of `shared/issues/260814-2022_c_*` now separates the two acts: the task edited neither JSON file, and `f0d9d60` nonetheless commits `fusion-guard.json`, where the working-tree line entered version control. `git show f0d9d60 --stat` lists `fusion-guard.json | 1 +` and no template, which is what the corrected sentence says. |
