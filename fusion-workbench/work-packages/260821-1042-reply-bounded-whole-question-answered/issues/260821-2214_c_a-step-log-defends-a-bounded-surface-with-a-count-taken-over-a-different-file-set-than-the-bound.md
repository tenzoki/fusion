...
**Fix.** Replace the clause with the figure the bound reads, which the same Turn already measured correctly twice: `260821-2120-coder-the-reply-answers-the-question-that-was-put.md:89-93` and `260821-2147-coder-the-corpus-is-measured.md:191` both give 20 364 and 11 lines of head-room. Correcting another agent's log in place has a precedent in this Circle and a stated bound on it: step 6 corrected two figures in step 2's log and touched nothing else (`260821-2147-coder-the-corpus-is-measured.md:225-240`).
