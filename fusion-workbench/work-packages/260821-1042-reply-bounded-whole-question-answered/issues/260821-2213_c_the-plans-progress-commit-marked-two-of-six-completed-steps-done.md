...
**Affects:** `260821-1805_*_plan-reply-bounded-whole-question-answered.md:100,108,127,151` (the four unmarked steps) and `:4` (the status field).
...
|---|---|---|---|
| 1 freeze the baseline | analyst | `260821-2020-analyst-the-reply-length-baseline-is-frozen.md` | no |
| 2 close the three routes | coder | `260821-2035-coder-close-the-three-routes-out-of-the-length-cap.md` | no |
| 3 the question clause | coder | `260821-2120-coder-the-reply-answers-the-question-that-was-put.md` | yes |
| 4 two register habits | ontocoder | `260821-2132-ontocoder-two-register-habits-in-four-profile-files.md` | no |
| 5 the cut | coder | `260821-2145-coder-the-cut-that-pays-for-steps-2-and-3.md` | yes |
| 6 measure and record | coder | `260821-2147-coder-the-corpus-is-measured.md` | no |
...
**What the fix is not.** Not a rename of the Circle record and not a closure. The Circle is still `_t_` and has open obligations, including `260812-0253_*_agents-answer-a-question-the-user-did-not-ask-and-the-length-caps-do-not-hold.md`, which the plan's `## Where this Circle stops` says steps 2, 3 and 5 close and which still stands at `_o_` with no `Resolved:` note.

**Cross-references:** commit `de0c6f6`; `rules/fusion-workbench-conventions.md` `## Inline State Tracking`; `260819-1511_*_a-session-history-file-is-left-at-status-in-progress-after-its-session-ended.md` (the same class on a different artifact kind).
