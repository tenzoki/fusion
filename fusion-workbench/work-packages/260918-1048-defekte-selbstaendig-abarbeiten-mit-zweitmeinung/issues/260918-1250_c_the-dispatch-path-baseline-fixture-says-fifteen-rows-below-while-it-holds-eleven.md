...
---
Resolved: The count is stamped to the 2026-09-09 arming (15 rows at commit 303488a8) and the deixis "below" is gone; the roster-cut section already records the move to eleven. Concept accepted by a consultant read; fixed in the commit that carries this line. Executed by coder rather than the record's ontocoder route: no routing rule names a .baseline fixture; agents/ontocoder.md's "Test files — coder" line covers a hand-edited prose comment in a hook-test fixture.
