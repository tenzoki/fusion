...
**Closes:** `260826-0139_*_three-citations-added-in-this-range-name-a-record-by-its-bare-stamp-a-day-after-the-rule-forbade-it.md`
...
| Site | Was | Is |
|---|---|---|
| `CLAUDE.md:43`, the `bin/fusion-events` Layout row | ``(issue `260823-1302`)`` | ``(issue `260823-1302_*_the-monitor-attributes-a-merged-event-log-to-one-session-and-reports-another-checkouts-state.md`)`` |
| `CLAUDE.md:43`, same row | ``per decision `260810-0921_*_how-should-a-prompt-call-a-bin-helper-that-the-installed-copy-may-not-have.md` `` | ``per decision `260810-0921_*_how-should-a-prompt-call-a-bin-helper-that-the-installed-copy-may-not-have.md` `` |
...
- `260823-1302-two-checkouts-one-event-log-and-what-the-monitor-makes-of-it.md`
- `260823-1302-c2-step-9-two-checkout-transport-verification.md`
...
`260810-0921_*_how-should-a-prompt-call-a-bin-helper-that-the-installed-copy-may-not-have.md` among them. The record claimed only the three this range added and the task claimed
...
`260826-0139_*_three-citations-added-in-this-range-name-a-record-by-its-bare-stamp-a-day-after-the-rule-forbade-it.md`
