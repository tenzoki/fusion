...
---
Resolved: 2026-08-06 — alle drei Stellen nachgezogen: Scope-Invoke-Liste um `conceptrev` und `editor` (`agents/orchestrator.md:165`), Invocation-Tabelle um die `editor`- und `playmaker`-Zeilen, der Playmaker-Verweis nennt dessen realen Schrittnamen statt "Bundle B process step 5". Commit 9a96466, Circle 260805-2005-textschicht-gegen-code-nachziehen (Plan-Schritt 11, Batch B).
