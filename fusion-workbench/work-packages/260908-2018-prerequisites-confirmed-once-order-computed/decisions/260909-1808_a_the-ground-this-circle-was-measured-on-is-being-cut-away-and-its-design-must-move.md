...
---
Answered: 260911-1528_*_spec-prerequisites-confirmed-once-order-computed.md `## What changed under the original shaping` — the recommendation this record made was carried out, and the session of 2026-09-11 and 2026-09-12 is the evidence. Option 2 for the dependency field: `**Depends-on:**` landed in the work item's first version at `76d833be`, inside the cut rather than after it. Option 1 for everything else: the specification was re-sharpened against what the cut left standing, re-measured at a commit that resolves, and the four questions it raised were put to the user and answered before the plan was written. The three consequences this record named all came about as it said they would — the carrier moved to the work-item head field, the consumer became a helper reporting on demand rather than a ranking to feed, and the stale snapshot was replaced rather than patched; ruled by user, Kai Stalmann <ks@qantr.com>.
