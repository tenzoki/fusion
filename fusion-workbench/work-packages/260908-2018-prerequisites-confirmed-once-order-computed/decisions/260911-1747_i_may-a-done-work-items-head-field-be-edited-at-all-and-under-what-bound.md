...
---
Implemented: 260918-0706 — the entry this record named as strikable is struck. `**Depends-on:** 260908-2018-prerequisites-confirmed-once-order-computed.md` is removed from the head of `260909-1700-cut-fusion-to-working-minimum.md`, one line and nothing else: the body, the status, the claim and every prose statement in that record stand exactly as they were, which is the bound this ruling set. The strike closes `260911-1747_*_the-migration-wrote-a-conflict-relation-into-depends-on-and-nobody-confirmed-it.md` and `260911-0715_*_a-depends-on-entry-asserts-an-ordering-where-the-section-it-was-derived-from-asserts-a-conflict.md`, in each of which it was the last open acceptance criterion.
