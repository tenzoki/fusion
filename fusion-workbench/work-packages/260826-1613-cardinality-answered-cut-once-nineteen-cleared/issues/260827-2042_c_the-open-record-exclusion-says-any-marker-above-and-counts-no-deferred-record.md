...
**Cross-references:** `260827-1741_*_tier-1-archives-a-terminal-circle-as-one-directory-and-never-reads-the-open-issues-inside-it.md` (its proposed line names `_o_`/`_p_` and `_o_`/`_a_` only); commit `d1489cc`
