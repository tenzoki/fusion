...
**Plan:** `260827-1756_*_repair-the-twenty-open-defect-records.md` step 7
**Decision:** `260827-1756_*_how-does-a-checkbox-criterion-say-that-its-condition-never-arose.md`, option 2
**Status:** Complete
...
- Record `260825-1250_*_a-conditional-acceptance-criterion-…` closed, `_o_` → `_c_` (the dispatch named it `_p_`; on disk it was `_o_`).
