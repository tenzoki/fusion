...
**Cross-references:** `260810-0819_*_head-carries-six-records-twice-and-the-class-fix-was-deferred-to-a-decision-never-filed.md`; `260810-2024_*_a-marker-rename-is-claimed-by-two-prompts-and-one-executor-moved-seven-other-executors-records.md`; `260816-0105_*_a-sub-agents-staged-rename-is-absorbed-by-the-orchestrators-next-commit-and-the-staging-list-cannot-prevent-it.md`; `260817-1502_*_a-sub-agent-left-renames-staged-and-the-orchestrators-next-commit-absorbed-them.md`; `archive/260817-1907-safe-cleanup-scoped/260807-1941_*_marker-renames-landed-add-only-so-head-carries-each-of-three-records-twice.md` (the closed instance that first deferred the class to a decision); `260811-0114_*_the-queue-rebuild-and-its-history-file-never-entered-a-commit-and-survive-only-in-the-working-tree.md` (the mirror measurement); `rules/fusion-workbench-conventions.md` `## State Markers — issues and planning`; `rules/commit-lock.md`; `agents/orchestrator.md` Step 3b; `agents/coder.md` (the executor's closing rename); plan `260824-1905_*_plan-close-every-open-defect.md` step 1 (D-rename-staging) and step 12 (the instance fix for the two absorption records)
