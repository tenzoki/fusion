...
- `260814-1850_*_the-new-dispatch-contract-is-reachable-from-no-flow-step-and-no-surface-offers-the-choice-it-waits-for.md:48`
- `260801-1244-guard-rules-write:131` (terminal Circle record; citation repair authorised by the orchestrator)
- `260815-1913_*_closing-the-plan-dangles-thirty-four-workbench-citations-that-spell-its-open-marker.md:8`
- `260820-2249_*_spec-style-rules-arrive-and-get-measured.md:505`
- `260816-0725_*_the-citation-gates-new-exact-count-pin-is-coupled-to-workbench-contents-so-the-archive-step-can-turn-it-red.md:73`
- `260816-1330_*_the-override-record-names-the-shipped-chat-profiles-cap-and-the-copy-every-agent-loads-says-otherwise.md:6,15`
