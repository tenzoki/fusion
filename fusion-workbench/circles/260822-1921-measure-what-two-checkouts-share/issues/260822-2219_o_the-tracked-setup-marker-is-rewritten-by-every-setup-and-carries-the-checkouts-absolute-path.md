...
---
Measured on 2026-08-22 in the C1 isolation pass, `circles/260822-1921-measure-what-two-checkouts-share/analyses/260822-2219-what-two-checkouts-of-one-project-actually-share.md` `## Findings` section 8.
...
- `shared/planning/260822-1136_*_spec-fusion-becomes-a-multi-user-tool.md` `## The state partition` class R3 says `.fusion-setup` and `.asset-provenance` "already tolerate a second writer, because a second setup writes the same kind of line about the same assets".
