...
---
Implemented: 23576fe6 — option 1, the whole-tree sweep: 111 citations in 45 files respelled to the storeless wildcard, `archive/` and terminal records included, with the 28 exhibits fenced, blockquoted or announced first so no specimen of the retired form was rewritten. The clause the ruling rests on went into `rules/fusion-workbench-conventions.md` `## Terminal states are history` at `af8d7fe0`, and `/fusion:migrate` gained the sweep as its closing step at `8032ee97`.
