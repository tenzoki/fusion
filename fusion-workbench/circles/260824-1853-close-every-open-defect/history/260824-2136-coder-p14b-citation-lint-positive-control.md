...
- Filed and closed `260824-2136_*_the-workbench-citation-lints-positive-control-requires-an-open-issue-on-disk-so-a-clean-workbench-fails-it.md` (person half absent: the installed copy carries no `bin/fusion-identity`).
...
- Plan `260824-1905_*_plan-close-every-open-defect.md`: steps 1, 2, 3, 4, 5, 8, 9, 14 marked `[DONE]`, Status Complete.
