...
**Cross-references:** `260801-1020_*_scan-keys-never-reach-the-archive-store.md`; `260823-1403_*_closing-a-circle-removes-its-open-records-from-every-agents-scan-set-and-no-closure-step-says-so.md`; `260801-1020-normative-surface-drift-gap-analysis.md` (Question 4, where the first was found); `rules/fusion-workbench-conventions.md` `## Path Resolution (Pfadauflösung)` and `## State Markers — decisions` (the Grounding-Historie layer); `rules/workbench-path-resolution.md`; `bin/fusion-paths`; `agents/orchestrator.md` Phase 4; `skills/archive/SKILL.md`; plan `260824-1905_*_plan-close-every-open-defect.md` step 1 (D-scan-scope)
