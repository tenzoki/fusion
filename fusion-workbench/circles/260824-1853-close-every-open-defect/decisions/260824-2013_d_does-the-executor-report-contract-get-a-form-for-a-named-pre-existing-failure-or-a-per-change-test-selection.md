...
**Cross-references:** `260810-0703_*_the-report-contract-derives-blocked-from-a-suite-exit-code-so-a-known-red-baseline-blocks-every-task.md`; `agents/coder.md` and `agents/ontocoder.md` (the `Verification:` forms and the derived `Result`); `rules/critical-stance.md` §2 and §4; plan `260824-1905_*_plan-close-every-open-defect.md` step 1 (D-report-baseline)
