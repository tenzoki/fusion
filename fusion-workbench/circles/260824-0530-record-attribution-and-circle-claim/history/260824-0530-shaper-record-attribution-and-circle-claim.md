...
**3. Does the filename question belong here.** Yes. `260822-1556_*_does-the-record-filename-convention-hold-when-several-checkouts-file-into-one-store.md` is placed at C3's planning gate by both the specification and the record itself, because C3 is the last cheap moment to change what a record is named. Recommendation accepted.
