...
---
Resolved: fixed — the criterion is met at HEAD; `grep -ril "long-form writing profile" stilwerk/` at HEAD 260824 prints `stilwerk/chat-voice-de.yaml`, `stilwerk/chat-voice-en.yaml`, `stilwerk/default-voice-en.yaml`, `stilwerk/default-voice-de.yaml`.
