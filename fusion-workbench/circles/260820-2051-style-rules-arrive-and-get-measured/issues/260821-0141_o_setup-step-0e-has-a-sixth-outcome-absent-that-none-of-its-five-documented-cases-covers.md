...
2. **`$g` absent** — the resolved shipped root does not carry the file. An empty `$FUSION_SRC` puts all four files here, which is filed separately as `260821-0140_o_setup-step-0e-reads-fusion-src-…`.
...
**Cross-references:** `circles/260820-2051-style-rules-arrive-and-get-measured/issues/260821-0140_o_setup-step-0e-reads-fusion-src-which-does-not-survive-the-fresh-shell-every-bash-call-gets.md`.
