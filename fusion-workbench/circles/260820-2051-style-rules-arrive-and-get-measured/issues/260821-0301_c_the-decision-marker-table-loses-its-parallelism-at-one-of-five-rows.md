...
issue filed at `260821-0300_*_four-replacements-stack-a-second-colon-in-one-sentence-which-the-pass-states-it-avoided.md` is about the four places where it was not applied. The cost it does not
...
**Cross-references:**
`260821-0300_*_four-replacements-stack-a-second-colon-in-one-sentence-which-the-pass-states-it-avoided.md`
