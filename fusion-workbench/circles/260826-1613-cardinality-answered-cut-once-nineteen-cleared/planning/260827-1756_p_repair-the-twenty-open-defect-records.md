...
- `shared/issues/260826-1315_*` and `260826-1331_*_npm-test-is-red-at-head-on-a-one-word-slug-drift-in-the-record-that-reports-the-eighth-count.md` closed at the 260827-1528-reconciliation.md reconciliation, and `260826-0906_*` (the EPIPE) closed at `15ef0a7`. None of the three is among the twenty.
