...
---
`skills/setup/SKILL.md:412` calls `"$FUSION_PLUGIN_ROOT/bin/fusion-plugin-cwd"` bare, in the line whose own prose (`:410`) cites the `[ -x ]` miss branch and decision `260810-1544`. Decision `260810-0921` makes the guard the convention at every `bin/` call site. Harmless today (exit 127 short-circuits the `&&` and stderr is dropped), and the one site in the file that breaks the rule it is there to measure.
---
**Filed by:** coderev, Kai Stalmann <ks@qantr.com>
**Cross-references:** `shared/decisions/260810-0921_*_how-should-a-prompt-call-a-bin-helper-that-the-installed-copy-may-not-have.md`; commit `abb0238`
