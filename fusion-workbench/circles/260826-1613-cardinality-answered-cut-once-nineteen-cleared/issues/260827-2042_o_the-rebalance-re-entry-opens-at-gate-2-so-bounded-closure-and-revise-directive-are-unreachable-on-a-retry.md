...
**Cross-references:** `circles/260826-1613-cardinality-answered-cut-once-nineteen-cleared/decisions/260827-1756_*_how-does-the-rebalance-gate-present-four-moves-under-a-three-option-cap.md` (option 2, whose `## Answer` says "every move stays reachable"); `rules/critical-stance.md` §4 (a case split is complete or the question is cut wrong); commit `799ea34`
