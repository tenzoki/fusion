...
All twenty open defect records in full (4 in the Circle store, 16 in `shared/issues/`), the Circle record, the four Circle histories of 260826/260827 and the 260827-1528-reconciliation.md reconciliation, the coderev review `260826-1858-coderev-playmaker-prompt-and-the-two-fabricated-claims.md`, the C4 cut-candidate analysis `260826-0715-cut-candidates-for-two-growth-bounded-surfaces.md`, the answered cardinality decision `260826-1252_a_*`, the two `260825-1030_a_*` gitignore decisions, `260810-1544_a_*`, `260822-1154_o_*`, `260823-1414_o_*`, `260824-2013_o_*`, and the shipped sites each record names.
...
- Plan: `260827-1756_*_repair-the-twenty-open-defect-records.md` (24 steps in five bundles; one cut under one gate, on `skills/` and the hook tests only).
