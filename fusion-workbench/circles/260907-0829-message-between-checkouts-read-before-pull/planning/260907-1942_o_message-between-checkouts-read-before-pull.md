...
2. **The two rule files learn the store**
   - Executor: `coder`
...
4. **`bin/fusion-forum`: fetch, delta, read, mark**
   - Executor: `coder`
...
5. **The three sites a new `bin/` helper owes**
   - Executor: `coder`
...
6. **A test that drives `bin/fusion-forum`**
   - Executor: `coder`
...
7. **The resolver test learns the forum keys**
   - Executor: `coder`
...
10. **`/fusion:cleanup` gains the message half of Step 6, and a selector**
    - Executor: `coder`
...
11. **Retention: tier-1 gains its first age-selected bucket**
    - Executor: `coder`
...
13. **Prove what can be proved in this session, and name what cannot**
    - Executor: `coder`
