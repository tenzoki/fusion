...
|---|---|---|---|
| `circles/260801-1244-curator/issues/260814-0813_*_…-validation-case.md` | 10 | `_a_` | `circles/260801-1244-curator/_*_circle.md` |
| the same record | 42 | `_t_` | the same |
| `circles/260801-1244-curator/issues/260814-1450_*_…-landed-the-review.md` | 26 | `_t_` | the same |
| `circles/260815-0007-…/issues/260815-0804_*_…-and-lists-six.md` | 15 | `_t_` | `circles/260815-0007-remove-eight-mechanisms-and-cap-growth/_*_circle.md` |
| `portfolio.md` | 72 | `_a_` | `circles/260819-1645-four-constraints-on-deep-change/_*_circle.md` |
| `shared/issues/260811-2105_*_…-citations-are-stale.md` | 37 | `_a_` | `circles/260801-1244-curator/_*_circle.md` |
| the same record | 102 | `_t_` | `circles/260816-1741-guard-becomes-observation-only/_*_circle.md` |
| `shared/issues/260813-0913_*_…-may-write-the-other.md` | 91 | `_a_` | `circles/260813-0858-playmaker-maintains-backlog-store/_*_circle.md` |
...
- **`shared/issues/260811-2105_*_…:37`** reads *"The single live (`_a_`) record — `circles/…/_*_circle.md` — carries eight literal citations"*.
...
- **`shared/issues/260811-2105_*_…:102`** is the same shape: the clause *"before that Circle's `_t_` → terminal transition"*
...
- **`circles/260815-0007-…/issues/260815-0804_*_…-activation-renamed.md:5`.** The record's entire
  ...
  **Still live**, and worth knowing: the cited decision's line 7 does still carry the stale spelling.
  ...
  instance.
- **`shared/issues/260813-0913_*_…-may-write-the-other.md:112`.** A reconciliation note of 260813-1545
