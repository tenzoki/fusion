...
| `archive/<sweep>/260719-1536-plane-mirror-integration` | `resolved` → the archived record |
| `260719-1536-plane-mirror-integration` (live path, archived record) | `resolved` → the archived record |
| `260719-1536-plane-mirror-integration` (live path, wrong marker) | **`stale-marker`** → the archived record |
| `fusion-workbench/circles/260819-1645-…/_t_circle.md` | `resolved` |
| `260101-0000-nothing-here` | `dangling` |
| `260801-1244-cura` (strict prefix of a real directory) | **`dangling`** — the negative control for `anchoredAt` |
...
`260801-1020_*_plane-mirror-circle-closed-with-empty-turn-log.md:5`. One citation
predates both. 13 + 15 = the twenty-eight, and each is inside the verified 30.

Per file: `260801-1244-curator` 5, `260801-1244-guard-rules-write` 4,
`260813-0913_*_a-dependency-between-two-circles-…` 3,
`260801-1244-rule-provenance-header` 3,
`260719-2141_*_concurrency-worktree-slots-vs-single-active-circle.md` 2,
`260816-1741-guard-becomes-observation-only` 2,
`260815-0007-remove-eight-mechanisms-and-cap-growth` 2,
`260813-0858-playmaker-maintains-backlog-store` 2,
`260716-1847-workbench-umbau` 2, and one each in `portfolio.md`,
`260718-1924-v5x-overhaul`,
`260813-1545_*_the-deferred-version-bump-…`,
`260801-1410_*_unattributed-edit-to-ontocoder-prompt-during-session.md` and
...
`260719-1536-plane-mirror-integration` 12,
`260813-0910-documentation-matches-shipped-plugin` 10,
`260801-1244-guard-bash-inspection` 2, and `260719-1536-demo-circle` 1 — the
...
as correct. The one `dangling` is `260719-1536-demo-circle` in
`circles/260815-0007-…/260815-0751-ontocoder-remove-plane-data-files-and-fixtures.md:96` — a
...
All three resolve to `archive/260817-1907-safe-cleanup-scoped/260719-1536-plane-mirror-integration`.
...
`skills/migrate/SKILL.md:96`, `260716-1847-umbau`. That file is in
...
|---|---|---|
| `260814-0813_*_…-validation-case.md` | `:10` → `_a_`, `:42` → `_t_` | `260801-1244-curator` (now `_c_`) |
| `260814-1450_*_…-landed-the-review.md` | `:26` → `_t_` | `260801-1244-curator` (now `_c_`) |
| `circles/260815-0007-…/260815-0804_*_…-activation-renamed.md` | `:5` → `_a_` | `260815-0007-remove-eight-mechanisms-and-cap-growth` (now `_c_`) |
| `circles/260815-0007-…/260815-0804_*_…-and-lists-six.md` | `:15` → `_t_` | `260815-0007-remove-eight-mechanisms-and-cap-growth` (now `_c_`) |
| `portfolio.md` | `:72` → `_a_` | `260819-1645-four-constraints-on-deep-change` (now `_t_`) |
| `260811-2105_*_…-citations-are-stale.md` | `:37` → `_a_` | `260801-1244-curator` (now `_c_`) |
| `260811-2105_*_…-citations-are-stale.md` | `:102` → `_t_` | `260816-1741-guard-becomes-observation-only` (now `_b_`) |
| `260813-0913_*_…-may-write-the-other.md` | `:91`, `:112` → `_a_` | `260813-0858-playmaker-maintains-backlog-store` (now `_c_`) |
