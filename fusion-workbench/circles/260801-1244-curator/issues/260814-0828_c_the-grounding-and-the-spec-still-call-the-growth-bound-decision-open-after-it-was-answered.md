...
---
Resolved: moot — a terminal Circle record is not edited, and the spec half is already fixed; `circles/260801-1244-curator/planning/260814-0738_*_spec-curator.md` `## User Decisions Pending`.
