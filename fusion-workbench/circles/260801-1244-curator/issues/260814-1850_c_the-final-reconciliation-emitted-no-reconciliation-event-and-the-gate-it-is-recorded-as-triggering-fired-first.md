...
---
Resolved: moot — the event log is append-only and an event is not written after the fact, as the record itself advises; `fusion-workbench/orchestrator-events.jsonl`.
