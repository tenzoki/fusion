...
| A consumer's cleanup prints `helper-missing` for one release | Stated in the docs note and the CLAUDE.md row; it is the standing cost of every `bin/` helper (`260825-1329_*_every-session-runs-one-release-behind-on-a-bin-helper-the-same-repository-just-added.md_*`) |
