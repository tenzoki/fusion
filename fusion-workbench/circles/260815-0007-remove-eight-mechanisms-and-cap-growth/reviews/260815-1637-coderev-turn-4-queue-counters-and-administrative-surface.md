...
`260815-1631_o_the-resume-shell-that-replaced-the-drift-check-prints-a-two-line-figure-and-an-empty-one.md`.
...
summary contains. Record: `260815-1631_o_setups-resume-summary-still-asks-for-diverging-rows-that-no-step-produces.md`.
...
commit. Record: `260815-1635_o_turn-budget-ts-header-still-says-the-orchestrator-carries-the-budget-in-agentstate-yaml.md`.
...
`260815-1633_o_queue-empty-left-the-event-vocabulary-in-p-10-and-only-queue-built-was-restored.md`.
...
`260815-1631_o_cleanups-notes-still-tell-the-assistant-to-run-it-end-to-end-after-the-gate-landed.md`.
...
`260815-1631_o_cleanup-dry-run-promises-no-writes-and-no-dispatch-and-step-5-does-both.md`.
...
Record: `260815-1633_o_cleanup-step-8-tells-the-user-to-run-fusion-curate-for-a-pass-step-5-of-the-same-run-performs.md`.
...
`260815-1635_o_cleanups-step-8-report-carries-two-different-bullets-under-one-label.md`.
...
`260815-1633_o_eight-shipped-surfaces-still-present-the-three-demoted-skill-names-as-user-commands.md`.
...
`260815-1633_o_the-claude-md-steps-only-selector-is-claude-md-and-the-documents-that-say-reachable-alone-never-spell-it.md`.
...
Record: `260815-1633_o_setup-step-0g-silently-replaces-a-project-s-existing-defaultmode.md`.
...
`260815-1635_o_the-gitignore-sweep-that-removed-two-dangling-ship-exceptions-missed-the-third.md`.
...
## The closed permission defect (`shared/issues/260810-0326_c_…`)
...
(`260815-1617_o_re-measure-whether-a-fresh-project-still-raises-approval-dialogs-before-setup-keeps-asking.md`).
...
1. **Two of the twelve are the two-copies-drift pattern arriving inside a single commit.** A1 is the
   ...
   `bin/fusion-source-root` to end exactly this class (decision `260810-2145`), and both instances
