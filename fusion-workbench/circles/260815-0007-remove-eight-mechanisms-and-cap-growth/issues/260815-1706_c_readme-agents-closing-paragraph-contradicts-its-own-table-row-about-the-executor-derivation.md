...
**Severity:** Medium
**Domain:** code
**Filed by:** `curator`, gate G1 survey run `circles/260815-0007-remove-eight-mechanisms-and-cap-growth/history/260815-1706-curator-run.md`
**Owner:** `coder`
**Affects:** `README-agents.md:79`
**Cross-references:**
`circles/260815-0007-remove-eight-mechanisms-and-cap-growth/decisions/260815-0029_*_what-triggers-the-analyst-executor-set-once-strategic-and-knowledge-are-gone.md` (implemented, option 1);
`circles/260815-0007-remove-eight-mechanisms-and-cap-growth/issues/260815-1447_*_claude-mds-dispatch-parameter-bullet-asserts-orchestrator-behaviour-step-9-inverted-not-just-a-value-list.md` (the same false clause in `CLAUDE.md`, which the curator's ledger carries as entry L05)
