...
**Plan:** `260816-1915_*_the-compliance-guard-becomes-observation-only.md`, step 13
**Status:** Complete
...
superseded by `260812-1232_*_does-the-escalation-counter-survive-a-block-source-that-ships-inert.md`.
...
- `260816-2316_*_step-13s-retired-line-list-is-wrong-…md`
...
decision stores for the identifiers this plan deletes. `260804-1630_*_what-does-a-project-guard-object-inherit-for-a-key-it-does-not-supply.md`'s `## Question`
...
**`260803-1419_*_…` and `260802-1912_*_…` got no second `Retired:` line.** Both
already carry `Retired: 60c9cd8`, at `:123` and `:95`.

**`260804-1632_*_should-findrelevantdecisions-fold-case-…` was left untouched.** No
...
- **`260802-1912_*_…` carries a stale citation.** Its `Retired:` line cites
  ...
  step authorises.
- **`260804-1631_*_…` has `**Status:** open` against an `_i_` marker.** Pre-existing,
...
- **`260815-2056_*_what-marks-an-answered-decision-whose-answer-can-no-longer-be-realised.md`
  ...
  instances are `_a_`; `260804-1632_*_should-findrelevantdecisions-fold-case-now-that-a-project-can-configure-categorypaths.md` is `_d_` and fails for the same reason. Not
