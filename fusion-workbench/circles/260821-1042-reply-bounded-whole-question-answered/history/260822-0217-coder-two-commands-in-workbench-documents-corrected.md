...
**Defect 1**, `issues/260822-0035_*_the-briefings-contamination-grep-marks-49-of-72-transcripts-primed-because-the-setup-skill-body-names-the-files-it-greps-for.md`.
A dated correction note was added to
`analyses/260822-0010-measurement-briefing-does-the-rule-change-shorten-a-reply.md`,
...
**Defect 2**, `issues/260822-0116_*_the-contamination-command-reads-a-scratch-directory-it-never-clears.md`.
...
its old marker as a letter: one in `history/260822-0035-analyst-three-before-figures-and-the-after-measurement.md`,
one in the filed-records list of `analyses/260822-0035-three-before-figures-and-the-after-measurement-defined.md`,
and one in the `Not-opened:` field of `reviews/260822-0121-ontorev-the-c06-rename-and-the-respelled-pointers.md`.
