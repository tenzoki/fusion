...
**Spec:** `260716-1847[o]-spec-plane-integration-und-workbench-struktur.md` (C1 und C2; C3 und C4 sind Circle 2 und nicht Gegenstand dieses Plans)
**Bindende Entscheidungen:** D2 `260716-1847[a]-workbench-struktur-circle-container-vs-typ-ordner.md`, D4 `260716-1847[a]-zuschnitt-umbau-und-plane-ein-oder-zwei-circles.md`, D1 `260716-1847[a]-plane-rolle-source-of-truth.md` (nur als Randbedingung)
...
**Beide Punkte sind am Gate 2026-07-16 vom Nutzer bestätigt worden und damit geschlossen.** Der Zustandsmarker sitzt an der Circle-Datei im stabil benannten Verzeichnis (Entscheidung: `260716-1910[a]-circle-marker-am-verzeichnis-oder-an-der-circle-datei.md`). Die gemeinsame Ablage heißt `shared/`. Die ursprünglichen Formulierungen bleiben zur Nachvollziehbarkeit stehen.
