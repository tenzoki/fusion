...
**Cross-references:**
`circles/260801-1244-guard-rules-write/issues/260804-1601_o_a-partial-guard-object-silently-removes-every-protected-path.md` (the measurement that raises this),
`circles/260801-1244-guard-rules-write/issues/260804-1603_o_the-project-config-layer-is-not-type-validated-so-a-wrong-type-fails-the-guard-open.md` (the validation whose drop behaviour this decides),
...
plan `circles/260801-1244-guard-rules-write/planning/260802-1856_o_plan-guard-rules-write.md` `### Q2` (where the consequence was reasoned through for one field and not turned around)
...
`circles/260801-1244-guard-rules-write/issues/260804-1633_o_the-omission-defect-is-latent-in-four-more-top-level-keys.md`.
