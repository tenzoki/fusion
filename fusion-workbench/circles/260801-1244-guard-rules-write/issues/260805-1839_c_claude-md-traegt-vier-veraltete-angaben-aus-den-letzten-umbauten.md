...
---
Resolved: 2026-08-06 — alle vier Angaben korrigiert: (1) Step 0d → Step 0c (beide Stellen), (2) die Circles-Zeile zitiert `rules/circle-records.md`, (3) die Monitor-TZ-Symptomzeile beschreibt den behobenen Stand (`parseUTCTs`-Routing, totes Issue-Zitat gestrichen), (4) der Prä-Container-Bus-Decisions-Pfad durch die Substanz ersetzt. Commit 9a96466, Circle 260805-2005-textschicht-gegen-code-nachziehen (Plan-Schritt 11, Batch B).
