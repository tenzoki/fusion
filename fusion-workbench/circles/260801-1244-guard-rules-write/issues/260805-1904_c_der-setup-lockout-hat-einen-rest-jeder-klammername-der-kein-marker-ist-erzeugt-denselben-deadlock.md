...
---
Resolved: 2026-08-06 — die Setup-Sonde filtert jetzt auf migrates exakte Executor-Menge `\[[oatcibspd]\]-` (`skills/setup/SKILL.md:43`, Prosa-Regel :38); dieselbe Probe-Konsistenz in migrates Survey und Kandidatenliste. `notes [draft].md` erzeugt keinen Lockout mehr (im Scratch-Workbench unter zsh und bash gemessen). Scope-Residual separat gefiled: `circles/260805-2005-textschicht-gegen-code-nachziehen/issues/260806-0022_o_setup-klammer-probe-und-migrate-reformat-decken-verschiedene-baeume.md`. Commit 7ef2715, Circle 260805-2005-textschicht-gegen-code-nachziehen (Plan-Schritt 6).
