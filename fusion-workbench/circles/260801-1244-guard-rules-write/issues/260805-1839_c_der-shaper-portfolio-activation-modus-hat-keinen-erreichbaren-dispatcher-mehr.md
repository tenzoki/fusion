...
---
Resolved: 2026-08-06 — der Modus ist ehrlich als nur-direkt-user-invozierbar beschrieben; die unerreichbare Dispatcher-Behauptung (playmaker / /fusion:next) ist entfernt, die Aktivierungs-Writes bleiben bei /fusion:next bzw. Orchestrator (`agents/shaper.md:47`, Frontmatter-Description nachgezogen). Commit 81d4154, Circle 260805-2005-textschicht-gegen-code-nachziehen (Plan-Schritt 9, D2 Option b).
