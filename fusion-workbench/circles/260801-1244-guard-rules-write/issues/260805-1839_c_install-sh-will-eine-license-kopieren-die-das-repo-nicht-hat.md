...
**Filed twice, independently, and neither filing found the other.** `260815-1631_*_the-installer-copy-list-names-a-license-file-the-tree-has-never-shipped.md` states the same defect from the same measurement, ten days later, in a different Circle. That is not a duplicate to merge away in a reconciliation pass — it is the second instance of the pattern `260817-1502_*_a-sub-agent-left-renames-staged-and-the-orchestrators-next-commit-absorbed-them.md` and `260816-0105_*_a-sub-agents-staged-rename-is-absorbed-by-the-orchestrators-next-commit-and-the-staging-list-cannot-prevent-it.md` record between them, a defect cheap to rediscover and invisible to every gate. Both are cross-annotated and both stay open; whoever fixes the line closes both.
...
---
Resolved: referred (decision) — whether fusion ships a LICENSE or the installer stops naming one is the decision's question; 260824-2013_*_does-fusion-ship-a-license-file-or-does-the-installer-stop-naming-one.md
