...
---
Rekonstruierbar: 10 → 9 (has_spec_plan entfernt) → 10 (git_stash_sha ergänzt); die Prosa blieb bei "nine". Emittiert an den Orchestrator, ausgeliefert; von /fusion:circle-stash und /fusion:circle-pop als Schema-Definition zitiert. Klasse 3 + interner Widerspruch, verifiziert. Analyse: 260805-1840-doku-gesamtpruefung-gegen-code.md
---
Resolved: 2026-08-06 — "nine fields" dreimal auf zehn korrigiert; die Historie 10→9→10 (`has_spec_plan` raus, `git_stash_sha` rein) ist im Text nachgezogen (`rules/workbench-stash-and-lock.md:32,71`). Commit fae818b, Circle 260805-2005-textschicht-gegen-code-nachziehen (Plan-Schritt 10, Batch A).
