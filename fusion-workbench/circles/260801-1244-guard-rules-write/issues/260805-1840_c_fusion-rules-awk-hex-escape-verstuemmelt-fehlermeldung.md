...
---
Nur diese eine Meldung ist betroffen (alle anderen `\x27` enden vor einem Hex-Zeichen). Exit 3 selbst stimmt. Konsumenten mit fehlerhaftem Manifest bekommen die verwirrende Diagnose genau im Moment des Fehlers. Klasse 1, verifiziert (Ausführung). Analyse: 260805-1840-doku-gesamtpruefung-gegen-code.md
---
