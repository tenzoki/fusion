...
---
Resolved: unfixable — the measurement runs on a machine this repository cannot reach and is a user action; the command to run there stands in the last paragraph above.
