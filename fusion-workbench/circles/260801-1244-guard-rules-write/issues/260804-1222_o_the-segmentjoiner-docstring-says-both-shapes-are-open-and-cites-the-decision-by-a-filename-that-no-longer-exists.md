...
**Cross-references:** `260804-0836_c_…` and `260804-0837_c_…` (the two shapes, both now closed); `decisions/260804-0947_i_…`; `260804-1221_o_…` (the same file, the same class).
...
1. **"both are open".** Both are closed. `true || cd build && rm rules/x.md` and
   ...
   `_c_`.
2. **The citation names `260804-0947_o_…`.** The record is at `_i_` and the file is
   `260804-0947_i_should-the-joiner-be-consulted-for-the-segment-that-moves-as-well-as-the-one-that-writes.md`.
...
or by its directory-stable prefix `260804-0947`.

Worth taking together with `260804-1221_o_…`, which is a second thing wrong in the same file
