...
---
Resolved: 2026-08-06 — /fusion:commit und /fusion:cleanup wickeln jeden stage+commit in `fusion-commit-lock with <skillname> --` (Tags `commit`, `cleanup`); Acquirer-Liste und Tag-Konvention in `rules/workbench-stash-and-lock.md:128` erweitert — "always, when any party is about to commit" stimmt jetzt. Commit 81d4154 (Plan-Schritt 9, D2 Lock-Unteroption i); Nachschliff in 36d9a30 (Staging in den gehaltenen Lock verlegt). Circle 260805-2005-textschicht-gegen-code-nachziehen.
