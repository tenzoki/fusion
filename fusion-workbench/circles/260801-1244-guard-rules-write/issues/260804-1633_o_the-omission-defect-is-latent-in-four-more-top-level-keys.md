...
**Cross-references:**
`circles/260801-1244-guard-rules-write/issues/260804-1601_o_a-partial-guard-object-silently-removes-every-protected-path.md` — the live instance of the same rule, on the one leaf where the two sources differ,
`circles/260801-1244-guard-rules-write/decisions/260804-1630_o_what-does-a-project-guard-object-inherit-for-a-key-it-does-not-supply.md` — the decision whose answer either closes this or leaves it,
...
`260804-1601_o_` reports this for `guard.protectedPaths`, where the two sources differ and the
...
This is the same shape as the reasoning that produced `260804-1601_o_` in the first place. The
...
No separate fix. Option 1 of decision `260804-1630_o_` — a key the project does not supply
