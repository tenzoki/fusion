...
Found while implementing plan step 2 (`circles/260801-1244-guard-bash-inspection/planning/260801-1253_o_plan-guard-bash-inspection.md`), by probing `parseCommand` on mutation-shaped commands rather than reasoning about it. Not a defect in step 1: `scanSegments` behaves as designed and as the git classifier needs. It is a gap between the parser's contract and what the plan's fail-closed rule assumed of it.
