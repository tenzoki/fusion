...
9. [NOTE: README-hooks.md was partly edited in step 6 — two lint gates forced it. It is now MORE internally inconsistent, not handled.] **Remove the always-on rule, its emission, its golden and every prose citation, in one commit**
   - Executor: `coder`
