...
**Corpus effect.** `dangling` 302 → **299** (313 → 310 if this step lands first). The three rows all carry the one sweep name, in two history files:

```
shared/history/260819-1400-reconciliation-circles.md:96   '260817-1907-safe-cleanup-scoped'  dangling
shared/history/260819-1400-reconciliation-circles.md:166  '260817-1907-safe-cleanup-scoped'  dangling
shared/history/260825-1453-curator-run.md:31              '260817-1907-safe-cleanup-scoped'  dangling
```
