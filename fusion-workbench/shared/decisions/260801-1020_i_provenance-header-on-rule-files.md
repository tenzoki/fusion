...
- Any header must not itself become drift. A `Cross-references:` line pointing at a decision that was later archived out of every read set (`shared/issues/260801-1020_o_scan-keys-never-reach-the-archive-store.md`) resolves to nothing. The two issues interact.
