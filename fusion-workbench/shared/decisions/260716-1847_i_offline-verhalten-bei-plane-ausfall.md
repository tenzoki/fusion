...
---
Answered: `circles/260716-1847-workbench-umbau/planning/260716-1847_o_spec-plane-integration-und-workbench-struktur.md` §"Entscheidungen (Kai)" D3 — "Weiterarbeiten, Plane ist sekundäre View" (keep working; Plane is a secondary view; a failure is never silent). Realisation is scoped into the Plane mirror Circle (C4). Bookkeeping caught at Plane-Circle prep, 2026-07-19.
