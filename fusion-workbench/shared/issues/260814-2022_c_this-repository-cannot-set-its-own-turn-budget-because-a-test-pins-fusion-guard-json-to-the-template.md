...
**Cross-references:** `circles/260813-0910-documentation-matches-shipped-plugin/issues/260813-2009_*_the-tuning-table-preamble-tells-the-reader-to-declare-a-key-the-project-layer-refuses.md` (the same shape one layer up — documentation telling a project to declare a key the mechanism refuses); `circles/260813-0910-documentation-matches-shipped-plugin/issues/260813-2009_*_the-turn-budget-row-says-no-hook-reads-the-key-while-describing-the-advisory-a-hook-emits.md`.
