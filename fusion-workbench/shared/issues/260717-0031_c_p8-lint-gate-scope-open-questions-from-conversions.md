...
Note item 4 interacts with the open namespace decision (`260716-1940_*_fusion-paths-argument-namespace-agents-vs-skills.md`): under option 2, skills resolve their own keys and the union problem disappears.

---
Collected by the orchestrator from findings reported by `coder` in tasks P-4, P-5, P-6, P-7 and T2-B.
Source: 260716-1910_*_plan-workbench-umbau-circle-container.md step 8
