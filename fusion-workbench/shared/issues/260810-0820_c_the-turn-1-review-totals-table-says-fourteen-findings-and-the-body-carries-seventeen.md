...
and `:178` adds "All fourteen are in `shared/issues/` with `_o_` markers, timestamps `260810-0455`
… `260810-0511`."
...
`260810-0455` and `260810-0511`, one per finding, and every one of them is real. Only the count is
...
---
Resolved: fixed — both reviews carry an appended correction (3/7/7/17 and seventeen; 5 commits) and the totals stay typed, said in the note; shared/reviews/260810-0512-coderev-turn-1-range-8960e1a-to-head.md:443 and shared/reviews/260810-0752-coderev-turn-2-range-ff70d3a-to-head.md:375
