...
**Top-ranked backlog entry:** `shared/backlog/260814-1733_*_bounded-executor-dispatches.md` — the
...
shaper into `circles/260815-0007-remove-eight-mechanisms-and-cap-growth` with a `Promoted:` line.

### Backlog writes performed

- `260814-1733_o_bounded-executor-dispatches.md` → `260814-1733_p_bounded-executor-dispatches.md`
...
Phase-4 run of 260814-2203 proposed `defer
shared/backlog/260814-1733_*_attach-the-rule-to-the-act.md until
...
`shared/backlog/260814-1733_*_attach-the-rule-to-the-act.md`. On merit, yes, and it is now the
...
store. On shapeability, no: the deferred decision `260810-0710_*` and the open issue `260810-0510_*`
...
- Two open decisions from the closed Circle bear on future Circles and block neither backlog
  ...
  and `shared/decisions/260815-2109_*_may-a-circle-close-over-an-uncovered-review-range-and-who-decides.md`.
