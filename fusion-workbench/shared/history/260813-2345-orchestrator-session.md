...
record's title and `## Dependencies` (`260814-0813_*_the-circle-records-title-and-dependencies-still-describe-the-conventions-file-as-the-validation-case.md`), and its `## Grounding snapshot` lag on the
answered growth-bound decision (`260814-0828_*_the-grounding-and-the-spec-still-call-the-growth-bound-decision-open-after-it-was-answered.md`). Note for whoever writes them: after the Turn-6
