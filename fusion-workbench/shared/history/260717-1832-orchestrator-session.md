...
**Issue gefiled:** `260717-1903[o]-skill-shell-scripts-assume-bash-glob-abort-under-zsh.md` — die Skript-Blöcke in migrate/setup gehen von bash-Glob-Semantik aus, brechen aber unter zsh am No-Match-Glob ab.
