...
**Status:** Complete
**Started:** 260811-2005
**Task:** `fusion-workbench/tasklist.md` tasks 12 (`I:260811-1610`) and 13 (`I:260811-1616`)
**Records:** `shared/issues/260811-1610_*_the-unmeasured-branches-discard-the-filed-count-which-needs-no-git-and-a-test-now-pins-the-discard.md`, `shared/issues/260811-1616_*_the-unmeasured-cause-list-assigns-a-project-outside-git-to-the-branch-that-cannot-reach-it.md`
