...
Two of the three edges being unevaluable is itself a gap in the shipped vocabulary, and this pass filed it: `shared/issues/260817-1836_o_the-three-edge-verdict-has-no-case-for-a-session-that-stated-no-directive-and-two-of-its-three-edges-are-then-unevaluable.md`.
