# Orchestrator Session — 260709-0816-orchestrator-session.md
...
Fix (commit 7f72dfe): double-quote the expansion (resolves at hook time) + `[ -n ... ]` empty-guard. Behaviorally verified both cases in-session. Live install `~/.fusion/hooks/hooks.json` patched directly (user chose "patch now"). Issue `260707-1019_*_fusion-plugin-root-unverified-on-marketplace-plugin-dir-installs.md` closed. Pending: user restarts fusion to confirm live.
...
- Issue closed: 260707-1019_*_fusion-plugin-root-unverified-on-marketplace-plugin-dir-installs.md → [c]
...
- **Open/in-progress issues:** 2
  - `260707-1006_*_pin-bash-allow-path-no-writeguard-side-effects-with-test.md` — pin bash allow-path no-writeguard-side-effects with a test
  - `260707-1019_*_fusion-plugin-root-unverified-on-marketplace-plugin-dir-installs.md` — fusion-plugin-root unverified on marketplace plugin-dir installs
- **Open decisions `[o]`:** 0
- **Analyses:** 1
