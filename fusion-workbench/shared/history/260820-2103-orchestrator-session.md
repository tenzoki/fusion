# Orchestrator Session — 260820-2103-orchestrator-session.md

**Directive:** See the active Circle's record — `260820-2051-style-rules-arrive-and-get-measured`
...
`260819-1645-four-constraints-on-deep-change` "is active". Its record is `_c_circle.md`,
...
Filed as
`260820-2157_*_the-records-dependencies-section-states-a-sibling-circle-is-active-and-that-circle-closed-before-the-record-was-written.md`,
