...
**Session:** `/fusion:cleanup` Step 3 after the orchestrator session `260827-1749-orchestrator-session.md` closed the Circle. Domain: code. No Circle active. Turn count: unavailable (`agentstate.yaml` absent, `bin/fusion-events turns` exit 3). HEAD `36cd574`, range `e9dc9b2..36cd574`, 9 commits.
...
5. **The attribution rule reaches four kinds and two of them do not write it.** 34 of 62 records stamped `260827` carry no person half: 21 history entries, 11 shared decisions, 2 shared issues. Filed as `260828-0044_*_thirty-four-of-sixty-two-records-filed-on-260827-carry-no-person-half-after-the-reach-was-settled.md`.
...
Second `## Coherence` block appended to the orchestrator session file (`circles/260826-1613-*/260827-1749-orchestrator-session.md`), marked as the post-closure pass: verdict `coherent`, recommendation `none`. Three edges: 11 verified / 0 drift / 0 reviewer issues; commits toward the Directive; 36 active decisions consistent, 0 conflicting.
