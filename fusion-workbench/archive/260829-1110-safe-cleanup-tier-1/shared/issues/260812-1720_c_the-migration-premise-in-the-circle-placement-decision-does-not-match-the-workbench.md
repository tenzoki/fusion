...
The answered decision `260812-0254_*_where-do-a-circles-spec-and-plan-belong-when-the-circle-exists-before-them.md`
...
|---|---|---|
| 260717-1918 | `260717-1918-planner-session.md` | yes — `260716-1847-workbench-umbau` |
| 260722-1943 | `260722-1943-shaper-plane-spec-comment.md` | no |
| 260722-2021 | `260722-2021-planner-plane-spec-comment.md` | no |
| 260801-1122 | `260801-1122-shaper-normative-consolidation.md` | no |
| 260807-2024 | `260807-2024-planner-two-language-declarations.md` | no |
| 260809-1229 | `260809-1229-plan-five-severe-guard-defects.md` | no |
| 260812-1232 | `260812-1232-planner-remove-the-protected-path-half.md` | no |
...
at closure, with the reason recorded at `260716-1847-workbench-umbau:49`.
...
**Where it is being handled.** `260812-1720_*_circle-first-placement-and-the-backlog-store.md`
...
---
**Reconciliation 260817-1836** (reconciler, domain `code`). Re-verified reproducible at HEAD `2552586`: `260812-0254_*_where-do-a-circles-spec-and-plan-belong-when-the-circle-exists-before-them.md:81` still states that the existing twelve Circles are migrated, with no correction note. The plan that would have executed it records that its step 12 never ran because the gate answered leave it, so the premise was never overtaken by events either. Marker stays open. Log: `260817-1836-reconciliation.md`.

---
Resolved: fixed — the decision record carries the corrected premise (ten of twelve Circles held their own planning documents; step 12 never ran); 260812-0254_*_where-do-a-circles-spec-and-plan-belong-when-the-circle-exists-before-them.md:143
