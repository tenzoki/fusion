...
**Domain:** code
**Filed by:** coder (working `260811-2145_*_the-deliverable-language-case-is-the-third-bullet-and-two-citing-surfaces-send-the-reader-to-the-fourth.md`, Turn 4 finding 1)
**Affects:** `hooks/lib/__tests__/deliverable-language-lint.test.ts`
**Cross-references:**
`archive/260817-1907-safe-cleanup-scoped/260811-2145_*_the-deliverable-language-case-is-the-third-bullet-and-two-citing-surfaces-send-the-reader-to-the-fourth.md` (its second acceptance criterion, carried here)
...
---
**Reconciliation 260817-1836** (reconciler, domain `code`). Re-verified reproducible at HEAD `2552586`: `hooks/lib/__tests__/deliverable-language-lint.test.ts` has no ordinal-citation scan; it tests only the deliverable-language default. Marker stays open. Log: `260817-1836-reconciliation.md`.
