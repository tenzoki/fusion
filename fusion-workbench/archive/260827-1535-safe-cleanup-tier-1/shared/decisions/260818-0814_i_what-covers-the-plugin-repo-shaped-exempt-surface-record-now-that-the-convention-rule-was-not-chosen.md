# What covers `260807-2153_*_the-exempt-surface-list-is-plugin-repo-shaped-but-ships-to-every-consumer.md` now that the convention rule was not chosen?

---
**Domain:** code
**Status:** answered
**Filed by:** reconciler, session `260818-0708-orchestrator-session.md`
**Cross-references:** `260818-0715-preventing-fusion-internal-identifiers-from-reaching-a-consuming-project.md` (recommendation 3 and Open Question 3); `260807-2153_*_the-exempt-surface-list-is-plugin-repo-shaped-but-ships-to-every-consumer.md` (the record left without a route); `260817-2131_*_nothing-stops-a-fusion-workbench-id-returning-to-an-emitted-hook-sentence-because-the-lint-reads-comment-lines-only.md` (the closed record whose resolution note carries the rejection)
...
Cleanup step deletes, and the closing paragraph of `260817-2131_*_nothing-stops-a-fusion-workbench-id-returning-to-an-emitted-hook-sentence-because-the-lint-reads-comment-lines-only.md`'s `Resolved:` note, which is a
...
surface that covers `260807-2153_*_the-exempt-surface-list-is-plugin-repo-shaped-but-ships-to-every-consumer.md`, the open sibling one layer up, where a rule file's *statement*
...
1. **`260807-2153_*_the-exempt-surface-list-is-plugin-repo-shaped-but-ships-to-every-consumer.md` is deferred with the convention.** Read the gate answer as covering both: the
...
2. **`260807-2153_*_the-exempt-surface-list-is-plugin-repo-shaped-but-ships-to-every-consumer.md` gets its own route, independent of the convention.** It is a defect about one
...
- `260807-2153_*_the-exempt-surface-list-is-plugin-repo-shaped-but-ships-to-every-consumer.md` must not be closed by this record. It is a defect; this decides what route it takes.
