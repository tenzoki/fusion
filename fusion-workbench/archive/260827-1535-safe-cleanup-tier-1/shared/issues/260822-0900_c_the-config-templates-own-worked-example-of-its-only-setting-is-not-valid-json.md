...
---
Resolved: fixed — the placeholder is gone (quote: grep -n maxTurns templates/fusion.json fusion.json output); the gate the body asks for was not built and is not a defect (orchestrator's ruling, plan 260824-1905 step 2).
