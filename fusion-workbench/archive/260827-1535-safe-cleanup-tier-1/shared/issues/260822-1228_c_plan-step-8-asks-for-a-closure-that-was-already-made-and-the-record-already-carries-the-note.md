...
raises"**, and cites
`260822-1154_*_does-the-hook-test-line-budget-cover-comment-prose.md` as the open
...
**Affects:** `260822-1154_*_plan-c0-cut-only-circle-buys-head-room-on-four-bounded-surfaces.md:158-164`;
`260821-2204_*_a-growth-bound-lost-half-its-head-room-against-a-stated-stopping-criterion-and-the-finding-lives-only-in-a-history-log.md`.
...
returns `260821-2204_*_a-growth-bound-lost-half-its-head-room-…`. It became `_c_` in `4a58be1`,
