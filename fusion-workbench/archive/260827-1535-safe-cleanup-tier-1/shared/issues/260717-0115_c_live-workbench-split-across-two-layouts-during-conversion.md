...
Observed: `260717-0107_*_prompt-gaps-surfaced-by-fusion-paths-key-set-derivation.md`, filed by `coder` during task T3-A. The agent behaved correctly; the sequencing is what is wrong.
...
Source: 260716-1910_*_plan-workbench-umbau-circle-container.md (risk table; steps 4-7 vs step 9 ordering)
