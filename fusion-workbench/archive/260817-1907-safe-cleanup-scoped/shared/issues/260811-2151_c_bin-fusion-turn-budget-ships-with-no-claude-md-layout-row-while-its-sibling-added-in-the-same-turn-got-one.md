...
**Cross-references:**
`260810-0410_*_the-layout-tree-calls-itself-exhaustive-and-omits-the-two-plane-runtime-files.md` (the same table, the same omission class)
...
Whether to close the other five gaps at the same time, or to state that the table is a selection rather than an inventory, is worth deciding once — `260810-0410_*_the-layout-tree-calls-itself-exhaustive-and-omits-the-two-plane-runtime-files.md` is open on the neighbouring table for the same reason.
