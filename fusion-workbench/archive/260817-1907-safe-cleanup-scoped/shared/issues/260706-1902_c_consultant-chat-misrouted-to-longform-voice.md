...
**Status:** closed
**Filed by:** analyst
**Cross-references:** 260706-1902-user-facing-agents-garbled-language-rootcause.md, 260706-1902_*_consultant-chat-longform-boundary.md
---
...
Depends on the boundary decision in `260706-1902_*_consultant-chat-longform-boundary.md` (expanded-on-request chat answers: chat-voice or long-form).
