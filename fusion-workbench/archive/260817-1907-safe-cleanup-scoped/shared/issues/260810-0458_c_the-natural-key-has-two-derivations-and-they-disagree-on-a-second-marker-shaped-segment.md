...
|---|---|---|
| `260719-1600_*_a_b-thing.md` | `260719-1600_*_b-thing.md` | `260719-1600_b-thing.md` |
...
runs against `260719-1600_*_a_b-thing.md` each planned `op=create`.
...
— `260719-1600_*_b.md` → `260719-1600_b.md` — and the map side relies on repeated application.
...
A third derivation site was found and filed separately, since closing it changes the wire format: 260810-1158_*_a-third-derivation-site-reads-the-key-back-out-of-a-plane-issue-body-which-carries-no-format.md
