...
---
Reconciled: 260813-2258-reconciliation.md — Still open, re-verified at HEAD `c0e4219`: `README-agents.md:65` still reads "falls back to the existing mode-detection heuristic, i.e. user-direct", and the `**Parent task:**` row at `:66`-neighbourhood still names the second absent-line outcome.
