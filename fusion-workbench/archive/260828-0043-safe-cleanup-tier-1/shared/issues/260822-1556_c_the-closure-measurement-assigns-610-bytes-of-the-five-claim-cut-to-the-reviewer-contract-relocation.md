...
**What each record says.** `shared/history/260822-1350-coder-cut-agents-surface-step3.md:28` says
...
`shared/history/260822-1540-coder-c0-step-9-closure-measurement.md:69-73` states it differently:
...
(`shared/decisions/260822-1330_*_…`, and the record's own constraint: "the relocation is reported as
...
**Affects:** `shared/history/260822-1540-coder-c0-step-9-closure-measurement.md:69-73`.
...
---
Resolved: fixed — the closure measurement carries the appended correction, 8 894 for the relocation and 610 as the reviewers' share of the five-claim cut; shared/history/260822-1540-coder-c0-step-9-closure-measurement.md:288
