...
---
**Reconciliation 260817-1836** (reconciler, domain `code`). Re-verified reproducible at HEAD `2552586`: `rules/user-facing-output.md:96` still leaves the cost unstated, `:101` and `:102` still cap the gate and the option label, `:107` still forbids relaxing, and the `description` field is still ungoverned. Marker stays open. Log: `260817-1836-reconciliation.md`.
...
and 14 of `260820-2051-style-rules-arrive-and-get-measured`.
